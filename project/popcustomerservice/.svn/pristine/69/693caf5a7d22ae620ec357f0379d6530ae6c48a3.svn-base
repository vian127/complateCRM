...
public class ServiceInfoVo implements Serializable{
  ...
  private String contactStatus;//联系状态

  private String record;//录音

  private String groundType;//地勤类型

  private String visitCount;//摆放次数

  private String groundRemark;//地勤备注

  private String staffName;//地勤备注
