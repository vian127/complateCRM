/*
	...
	#date 		2017/03/28
*/
define(["jquery","msg",'base-info'],function(jquery,msg,global_info){
    return {
        def:{
            host_origin_path:'',
            js_path:"",        //js访问路径
        ...
        fn:{
            ...
            subAjax:function(options){                  //jquery  ajax封装
                ...
                // 针对接口加入特定header
                options.header={
                    'userToken':global_info.user_info.user_token
                }
                ...
                if(opt["type"]!=undefined && opt["type"].toUpperCase()=="POST"){
                    opt["data"]=JSON.stringify(options["data"]?options["data"]:{});
                }
